const services = [
    {
        ...
        description: "CCTV, access control, gate barriers, sliding doors and intruder alarms, scalable from a single entrance to a full estate.",
    ...
    {
        title: "Automation",
        description: "Lighting control (LCS), BMS, GRMS and full home automation, programmable, app-controlled and energy-aware.",
    ...
    },
    {
        ...
        description: "Security and automation harmonized into one platform, one interface, lower running costs, scales with your project.",
    ...
    {
        title: "Audio-Visual",
        description: "Home cinema to enterprise AV, 4K MOIP distribution, smart classrooms, PA/paging and meeting room solutions.",
    ...
    },
    {
        ...
        description: "Structured cabling, PABX and networking for a complete telecommunication infrastructure in commercial and residential projects.",
    ...
    },
    {
        ...
        description: "Set energy limits and policies across any building type, reducing waste and running cost from standalone to complex EMS.",
